...
[![Docker Image Size (latest semver)](https://img.shields.io/docker/image-size/markcaudill/terraform-http-backend)](https://hub.docker.com/repository/docker/markcaudill/terraform-http-backend)
[![GitHub](https://img.shields.io/github/license/markcaudill/terraform-http-backend)](LICENSE)
